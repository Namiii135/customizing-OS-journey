...
const resizeHost = document.querySelector(".Root__main-view .os-size-observer, .Root__main-view, .main-view-container__scroll-node" ) ?? document.querySelector(".Root__main-view .os-size-observer");    const [windowSize, setWindowSize] = (0, import_react2.useState)(resizeHost.clientWidth);
